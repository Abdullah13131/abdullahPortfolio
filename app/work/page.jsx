...
},
{
    ...
    title: "Project 02",
    description: "This is my Web development project made in HTML, CSS and Javascript, and Php, Laravel. Its a railway reservation website. From where user can book online tickets easily.",
    stack: [{name: "HTML5"},{name: "CSS3"},{name: "Javascript"}, {name: "PHP"},{name: "Laravel"}],
...
},
{
    ...
    title: "Project 04",
    description: "For my Final Year Project, I developed an Intelligent Marketing Agent (IMA) using the MERN stack (MongoDB, Express.js, React, Node.js). This application is designed to help businesses efficiently market their products and services. This project aims to enhance marketing efficiency and effectiveness for businesses, driving better customer engagement and sales.",
    stack: [{name: "Node.js"} , {name: "Express.js"},{name: "MongoDB"} , {name: "React.js"},{name: "HTML5"} ,{name: "CSS3"}, {name: "Javascript"}],
        ...
        <div className=" container mx-auto">
            <div className="flex flex-col xl:flex-row xl:gap-[30px]">
                ...
                <div className="text-8xl font-extrabold text-outline text-transparent leading-none">
                        {project.num}</div>
                        <h2 className="text-[42px] font-bold text-white leading-none group-hover:text-accent transition-all duration-500 capitialize" >
